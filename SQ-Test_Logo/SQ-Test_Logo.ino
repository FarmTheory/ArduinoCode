...
#include <PNGdec.h>
#include "slurryquip_logo.h" // Image is stored here in an 8 bit array

PNG png; // PNG decoder inatance

#define MAX_IMAGE_WDITH 150 // Adjust for your images
...
void loop()
{
  int16_t rc = png.openFLASH((uint8_t *)slurryquip_logo, sizeof(slurryquip_logo), pngDraw);
  if (rc == PNG_SUCCESS) {
