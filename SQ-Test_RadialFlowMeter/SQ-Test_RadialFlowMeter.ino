...
void analogMeter()
{
  ...
  for (int i = -50; i < 51; i += 5) {
    ...
    if (i % 25 == 0) {
      ...
      switch (i / 25) {
        ...
        case -1: tft.drawCentreString("20", x0, y0 - 9, 2); break;
        case 0: tft.drawCentreString("100", x0, y0 - 7, 2); break;
  ...
  tft.drawString("m3/hr", M_SIZE*(5 + 230 - 40), M_SIZE*(119 - 20), 2); // Units at bottom right
  tft.drawCentreString("FlowRate", M_SIZE*120, M_SIZE*70, 4); // Comment out to avoid font 4
...
void plotNeedle(int value, byte ms_delay)
{
  ...
  while (!(value == old_analog)) {
    ...
    tft.drawLine(M_SIZE*(120 + 20 * ltx), M_SIZE*(140 - 20), osx, osy, TFT_RED);
    tft.drawLine(M_SIZE*(120 + 20 * ltx + 1), M_SIZE*(140 - 20), osx + 1, osy, TFT_RED);
