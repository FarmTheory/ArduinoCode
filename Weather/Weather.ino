...
// data connection and acquisition variables
   const char* ssid =            "NAME OF YOUR WIFI NETWORK";                               // network wifi credentials  
   const char* password =        "KEY OF YOUR WIFI NETWORK";                                // wifi network key
   String openWeatherMapApiKey = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";                        // API Openweathermap account
   String city =                 "Your city";
   String countryCode =          "country code";                                            // "NL" for The Netherlands
