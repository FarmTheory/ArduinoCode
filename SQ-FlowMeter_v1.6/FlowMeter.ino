  ...
  for (int i = -50; i < 51; i += 5) {
        ...
        if (i % 25 == 0) {
          ...
          switch (i / 25) {
            ...
            case -1: fmSprite.drawCentreString("50", flowBX+x0, flowBY+y0 - 9, 2); break;
            case 0: fmSprite.drawCentreString("100", flowBX+x0, flowBY+y0 - 7, 2); break;
            case 1: fmSprite.drawCentreString("150", flowBX+x0, flowBY+y0 - 9, 2); break;
            case 2: fmSprite.drawCentreString("200", flowBX+x0, flowBY+y0 - 12, 2); break;
          }
        }
        fmSprite.unloadFont();
  ...
  while (!(value == old_analog)) {
   ...
   // fmSprite.unloadFont(); 
    ...
    //  Serial.println(value);
      ...
      char *fmtValue = flowBuffer;
      fmSprite.loadFont(large60);
      fmSprite.setTextColor(textColour,c2);
      fmSprite.fillRect(flowBX-60+flowWidth/2, flowBY+70, 110, 50, c2);
