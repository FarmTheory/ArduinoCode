...
void drawCounter(int value, char *label)
{
  ...
  ctSprite.drawString(label,counterBX+89+48,counterBY+62);
  ...
  ctSprite.loadFont(small);
  ctSprite.setTextColor(c1,c2);
  ctSprite.drawString("HIST",counterBX+25,counterBY+58);
  ctSprite.unloadFont();
  //RESET +15
  ...
  ctSprite.drawString(String(d0),counterBX+60,counterBY+29);
  ctSprite.drawString(String(d1),counterBX+96,counterBY+29);
  ctSprite.drawString(String(d2),counterBX+132,counterBY+29);
  ctSprite.drawString(String(d3),counterBX+168,counterBY+29);
  ctSprite.drawString(String(d4),counterBX+204,counterBY+29);
  ctSprite.unloadFont(); 
  //Push to Screen
